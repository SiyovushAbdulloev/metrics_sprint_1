...
//
// gRPC сервис для отправки метрик
type MetricsServiceClient interface {
	SendMetrics(ctx context.Context, in *MetricsRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *metricsServiceClient) SendMetrics(ctx context.Context, in *MetricsRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
...
type MetricsServiceServer interface {
	SendMetrics(context.Context, *MetricsRequest) (*empty.Empty, error)
...
func (UnimplementedMetricsServiceServer) SendMetrics(context.Context, *MetricsRequest) (*empty.Empty, error) {
